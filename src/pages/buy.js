                        ...
                        <div className='body'>
                            <div className='token-info'>
                                <div className='symbol'>
                                    <img src={book.sellTokenInfo.logo} width={85} height={85}/>
                                    <div className='name-and-address'>
                                        <span className='no'>#{id}</span>
                                        <span className='name'>{book.sellTokenInfo.symbol}</span>
                                        <span className='address'>
                                            <span>
                                                {book.sellTokenInfo.address.slice(0,8)}
                                            </span>
                            ...
                            <div className='price-setting'>
                                <div className='prices'>
                                    <div className='offer'>
                                        <img src={book.sellTokenInfo.logo} width={30}/>
                                        <span>{book.sellTokenAmount}</span>
                                        <span>Offer</span>
                                    </div>
                                    <div className='for'>
                                        <img src={book.forTokenInfo.logo} width={30}/>
                                        <span>{book.forTokenAmount}</span>
                                        <span>For</span>
                                    </div>
                                    <div className='price'>
                                ...
                                <div className='buy'>
                                    <div className='description'>
                                        ...
                                        <img src={book.sellTokenInfo.logo} width={27}/>
                                    </div>
                                    <div className='amount'>
                                        {book.sellTokenAmount * percent / 100}
                                    </div>
